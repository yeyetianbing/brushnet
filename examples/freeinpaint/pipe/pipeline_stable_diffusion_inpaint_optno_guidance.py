...
class StableDiffusionInpaintOptNoGuidancePipeline(
    DiffusionPipeline,
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latent_model_input = self.scheduler.scale_model_input(latent_model_input, t)    # this is identical for ddim and dpm
